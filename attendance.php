 ...
 include 'session.php';?>
				...
				<div class="card">
					...
					<div class="card-body">
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									$att=$conn->query("SELECT a.*,e.employee_no, concat(e.lastname,', ',e.firstname) as ename FROM attendance a inner join employee e on a.employee_id = e.id  order by UNIX_TIMESTAMP(datetime_log)") or die(mysqli_error());
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#table').DataTable({
			"lengthMenu": [[100,10,-1], [100, 10, "All"]]
		})});
	</script>
	<script type="text/javascript">
		$(document).ready(function(){
